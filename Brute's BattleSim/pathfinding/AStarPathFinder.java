 ...
 * determine a path. InfuriatedBrute added the RNG part. Otherwise the code was
 * copied from the Code and Coke blog
 * 
 * @author Kevin Glass
...
public class AStarPathFinder implements PathFinder {
	...
	/** The random object passed from the battle in order to allow for seeded RNG */
	 ...
	 */
	public AStarPathFinder(TileBasedMap map, int maxSearchDistance, boolean allowDiagMovement, Random random) {
		this(map, maxSearchDistance, allowDiagMovement, new ClosestHeuristic(), random);
	}
